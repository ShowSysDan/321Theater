...
def migrate_db():
    ...
    for alter_sql in [
        ...
        "ALTER TABLE users ADD COLUMN last_conn_path TEXT DEFAULT ''",
        "ALTER TABLE users ADD COLUMN last_conn_ip TEXT DEFAULT ''",
        'ALTER TABLE users ADD COLUMN last_conn_at TIMESTAMP',
        ...
        'ALTER TABLE shows ADD COLUMN assets_approved_by INTEGER REFERENCES users(id) ON DELETE SET NULL',
        'ALTER TABLE shows ADD COLUMN assets_approved_at TIMESTAMP',
        'ALTER TABLE shows ADD COLUMN assets_approval_snapshot TEXT',
        ...
        "ALTER TABLE labor_requests ADD COLUMN break2_start TEXT DEFAULT ''",
        "ALTER TABLE labor_requests ADD COLUMN break2_end TEXT DEFAULT ''",
        "ALTER TABLE labor_requests ADD COLUMN notes TEXT DEFAULT ''",
        "ALTER TABLE shows ADD COLUMN labor_notes TEXT DEFAULT ''",
        "ALTER TABLE overhead_labor_requests ADD COLUMN break2_start TEXT DEFAULT ''",
        "ALTER TABLE overhead_labor_requests ADD COLUMN break2_end TEXT DEFAULT ''",
        "ALTER TABLE overhead_labor_requests ADD COLUMN actual_break2_start TEXT DEFAULT ''",
        "ALTER TABLE overhead_labor_requests ADD COLUMN actual_break2_end TEXT DEFAULT ''",
        "ALTER TABLE overhead_labor_templates ADD COLUMN break2_start TEXT DEFAULT ''",
        "ALTER TABLE overhead_labor_templates ADD COLUMN break2_end TEXT DEFAULT ''",
